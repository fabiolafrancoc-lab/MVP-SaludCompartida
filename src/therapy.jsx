...
const AnxietyTips = ({ onBack }) => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-cyan-50">
      ...
      <TopNav internalPage={true} showBackButton={true} onBack={onBack} />
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          ...
          <h1 className="text-base md:text-xl lg:text-2xl font-bold text-gray-900 mb-4 text-center">
            Cómo reducir tu ansiedad
          </h1>

          <div className="bg-gradient-to-r from-cyan-100 to-purple-100 rounded-xl p-6 mb-8">
            <p className="text-sm md:text-base lg:text-lg text-gray-800 italic text-center font-semibold">
          ...
          <div className="space-y-6">
            <div className="bg-cyan-50 rounded-xl p-6">
              <h3 className="font-bold text-gray-900 mb-3 text-base md:text-xl lg:text-2xl">1. Respira profundo cuando sientas el pecho apretado</h3>
            ...
            <div className="bg-purple-50 rounded-xl p-6">
              <h3 className="font-bold text-gray-900 mb-3 text-base md:text-xl lg:text-2xl">2. Escribe lo que te preocupa</h3>
              <p className="text-gray-700 mb-3">
            ...
            <div className="bg-pink-50 rounded-xl p-6">
              <h3 className="font-bold text-gray-900 mb-3 text-base md:text-xl lg:text-2xl">3. Mueve tu cuerpo 10 minutos al día</h3>
              <p className="text-gray-700 mb-3">
            ...
            <div className="bg-cyan-50 rounded-xl p-6">
              <h3 className="font-bold text-gray-900 mb-3 text-base md:text-xl lg:text-2xl">4. Limita el café y las noticias</h3>
              <p className="text-gray-700 mb-3">
            ...
            <div className="bg-purple-50 rounded-xl p-6">
              <h3 className="font-bold text-gray-900 mb-3 text-base md:text-xl lg:text-2xl">5. Habla con alguien de confianza</h3>
              <p className="text-gray-700 mb-3">
          ...
          <div className="mt-8 bg-gradient-to-r from-purple-100 to-pink-100 rounded-xl p-6">
            <p className="text-gray-700 text-center font-semibold text-sm md:text-base lg:text-lg">
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-cyan-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          ...
          <div className="space-y-6">
            <div className="bg-purple-50 rounded-xl p-6">
              <h3 className="font-bold text-gray-900 mb-3 text-base md:text-xl lg:text-2xl">1. Escucha de verdad, no solo para responder</h3>
              <p className="text-gray-700 mb-3">
            ...
            <div className="bg-pink-50 rounded-xl p-6">
              <h3 className="font-bold text-gray-900 mb-3 text-base md:text-xl lg:text-2xl">2. Di lo que sientes sin atacar</h3>
              <p className="text-gray-700 mb-3">
            ...
            <div className="bg-cyan-50 rounded-xl p-6">
              <h3 className="font-bold text-gray-900 mb-3 text-base md:text-xl lg:text-2xl">3. Perdona, pero también pon límites</h3>
              <p className="text-gray-700 mb-3">
            ...
            <div className="bg-purple-50 rounded-xl p-6">
              <h3 className="font-bold text-gray-900 mb-3 text-base md:text-xl lg:text-2xl">4. Celebra lo bueno, no solo señales lo malo</h3>
              <p className="text-gray-700 mb-3">
            ...
            <div className="bg-pink-50 rounded-xl p-6">
              <h3 className="font-bold text-gray-900 mb-3 text-base md:text-xl lg:text-2xl">5. Pide lo que necesitas claramente</h3>
              <p className="text-gray-700 mb-3">
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-cyan-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          ...
          <div className="space-y-6">
            <div className="bg-pink-50 rounded-xl p-6">
              <h3 className="font-bold text-gray-900 mb-3 text-base md:text-xl lg:text-2xl">1. Haz listas simples y tacha lo que terminas</h3>
              <p className="text-gray-700 mb-3">
            ...
            <div className="bg-purple-50 rounded-xl p-6">
              <h3 className="font-bold text-gray-900 mb-3 text-base md:text-xl lg:text-2xl">2. Di "no" sin culpa cuando sea necesario</h3>
              <p className="text-gray-700 mb-3">
            ...
            <div className="bg-cyan-50 rounded-xl p-6">
              <h3 className="font-bold text-gray-900 mb-3 text-base md:text-xl lg:text-2xl">3. Duerme aunque creas que no hay tiempo</h3>
              <p className="text-gray-700 mb-3">
            ...
            <div className="bg-pink-50 rounded-xl p-6">
              <h3 className="font-bold text-gray-900 mb-3 text-base md:text-xl lg:text-2xl">4. Toma pausas de 5 minutos cada hora</h3>
              <p className="text-gray-700 mb-3">
            ...
            <div className="bg-purple-50 rounded-xl p-6">
              <h3 className="font-bold text-gray-900 mb-3 text-base md:text-xl lg:text-2xl">5. Suelta lo que no puedes controlar</h3>
              <p className="text-gray-700 mb-3">
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-cyan-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full">
          <div className="text-center mb-6">
            ...
            <h2 className="text-sm md:text-base lg:text-lg font-bold text-gray-900 mb-2">¡Bienvenido!</h2>
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-cyan-50">
        ...
        <div className="max-w-2xl mx-auto px-4 py-16">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <h2 className="text-base md:text-xl lg:text-2xl font-bold text-gray-900 mb-4">
            ...
            <div className="bg-gradient-to-r from-purple-100 to-pink-100 rounded-xl p-6 mb-8">
              ...
              <p className="text-sm md:text-base lg:text-lg font-bold text-gray-900 mb-1">
                {selectedDate.toLocaleDateString('es-MX', { weekday: 'long', day: 'numeric', month: 'long' })}
              </p>
              <p className="text-base md:text-xl lg:text-2xl text-gray-700">{selectedTime} hrs</p>
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm text-gray-700">
                    <div className="flex items-start gap-2">
                      ...
                      <span><strong>Por WhatsApp:</strong> Envía un mensaje al <a href={`https://wa.me/5529984922702?text=${encodeURIComponent('Hola, tengo una pregunta sobre mi sesión de terapia del ' + selectedDate.toLocaleDateString('es-MX'))}`} className="text-[#25D366] hover:underline font-semibold">55 2998 4922 702</a></span>
                    </div>
        ...
        {showCancelModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8">
              ...
              <h3 className="text-sm md:text-base lg:text-lg font-bold text-gray-900 text-center mb-4">
        ...
        {showThankYouMessage && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8">
              ...
              <p className="text-sm md:text-base lg:text-lg text-gray-700 text-center mb-6">
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-cyan-50">
      ...
      <div className="max-w-7xl mx-auto px-safe py-safe">
        ...
        <div className="text-center mb-12">
          <h1 className="text-base md:text-xl lg:text-2xl md:text-sm md:text-base lg:text-lg font-bold text-gray-900 mb-4">
            Tu Salud Mental Importa
          </h1>
          
          <p className="text-base md:text-xl lg:text-2xl text-gray-600 mb-6 max-w-3xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-xl p-6 mb-8 max-w-3xl mx-auto">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-base md:text-xl lg:text-2xl font-bold text-gray-900 mb-2">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-12">
          <h2 className="text-sm md:text-base lg:text-lg font-bold text-gray-900 mb-6">
            ¿Por qué terapia?
          </h2>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-12">
          <h2 className="text-sm md:text-base lg:text-lg font-bold text-gray-900 mb-2 text-center">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              {availableDates.map((date, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-sm md:text-base lg:text-lg font-bold">{formatted.date}</div>
          ...
          <button
            ...
            className={`w-full py-4 rounded-xl font-bold text-sm md:text-base lg:text-lg transition-all ${
