...
export default function RegistroNuevo() {
  ...
  const [formData, setFormData] = useState({
    // Migrant data
    migrantNombre: '',
    migrantApellidoPaterno: '',
    migrantApellidoMaterno: '',
    migrantSexo: '',
    migrantFechaNacimiento: '',
    migrantEmail: '',
    migrantWhatsapp: '',
    // Family data
    familyNombre: '',
    familyApellidoPaterno: '',
    familyApellidoMaterno: '',
    familySexo: '',
    familyFechaNacimiento: '',
    familyEmail: '',
    familyWhatsapp: '',
  });
  ...
  return (
    <>
      <NewHeader />
      <div style={{ paddingTop: '80px', paddingBottom: '100px', background: '#FFFFFF' }}>
        <style jsx global>{`
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                <div className="form-row">
                  ...
                  <div>
                    ...
                    <input 
                      type="text" 
                      name="migrantApellidoPaterno"
                      className="form-input" 
                      placeholder="García"
                      value={formData.migrantApellidoPaterno}
                      onChange={handleChange}
                      required
                    />
                  </div>
                  <div>
                    ...
                    <input 
                      type="text" 
                      name="migrantApellidoMaterno"
                      className="form-input" 
                      placeholder="López"
                      value={formData.migrantApellidoMaterno}
                      onChange={handleChange}
                    />
                  </div>
                </div>
              ...
              <div className="form-group">
                <div className="form-row" style={{ gridTemplateColumns: '1fr 1fr' }}>
                  ...
                  <div>
                    ...
                    <input 
                      type="date" 
                      name="migrantFechaNacimiento"
                      className="form-input"
                      value={formData.migrantFechaNacimiento}
                      onChange={handleChange}
                      required
                    />
              ...
              <div className="form-group">
                ...
                <div className="phone-input-wrapper">
                  ...
                  <input 
                    type="tel" 
                    name="migrantWhatsapp"
                    className="phone-input" 
                    placeholder="+13051234567 o 3051234567"
                    value={formData.migrantWhatsapp}
                    onChange={handleChange}
                    required
                  />
                </div>
              ...
              <div className="form-group">
                <div className="form-row">
                  ...
                  <div>
                    ...
                    <input 
                      type="text" 
                      name="familyApellidoPaterno"
                      className="form-input" 
                      placeholder="Hernández"
                      value={formData.familyApellidoPaterno}
                      onChange={handleChange}
                      required
                    />
                  </div>
                  <div>
                    ...
                    <input 
                      type="text" 
                      name="familyApellidoMaterno"
                      className="form-input" 
                      placeholder="Pérez"
                      value={formData.familyApellidoMaterno}
                      onChange={handleChange}
                    />
                  </div>
                </div>
              ...
              <div className="form-group">
                <div className="form-row" style={{ gridTemplateColumns: '1fr 1fr' }}>
                  ...
                  <div>
                    ...
                    <input 
                      type="date" 
                      name="familyFechaNacimiento"
                      className="form-input"
                      value={formData.familyFechaNacimiento}
                      onChange={handleChange}
                      required
                    />
