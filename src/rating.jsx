      ...
      <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-white to-magenta-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-3xl shadow-2xl p-12 max-w-md w-full text-center">
          <div className="mb-6">
            ...
            <p className="text-gray-600 text-base md:text-2xl lg:text-3xl">
    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-white to-magenta-50">
      ...
      <div className="max-w-3xl mx-auto px-4 pb-12">
        <div className="bg-white rounded-3xl shadow-xl p-8">
          ...
          {step === 1 && (
            <div className="text-center">
              ...
              <div className="mb-8 bg-gradient-to-r from-orange-50 to-pink-50 rounded-2xl p-6 border-2 border-orange-200">
                <p className="text-lg md:text-3xl lg:text-4xl font-bold text-orange-600 mb-3">
              ...
              <p className="text-cyan-600 text-base md:text-2xl lg:text-3xl font-semibold mb-8">
              ...
              {rating > 0 && (
                <div className="bg-cyan-50 rounded-2xl p-6 mb-6">
                  ...
                  <p className="text-base md:text-2xl lg:text-3xl font-semibold text-gray-900">
              ...
              <button
                onClick={() => setStep(2)}
                disabled={!canProceed()}
                className="bg-gradient-to-r from-cyan-500 to-cyan-600 text-white px-8 py-4 rounded-xl font-semibold text-base md:text-2xl lg:text-3xl hover:from-cyan-600 hover:to-cyan-700 transition-all transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
              >
                Continuar
              </button>
            </div>
          ...
          {step === 2 && (
            <div>
              <h2 className="text-base md:text-2xl lg:text-3xl font-bold text-gray-900 mb-3">
