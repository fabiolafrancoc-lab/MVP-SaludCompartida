    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-pink-50 to-cyan-50">
      ...
      <header className="bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <button
            onClick={() => navigate('/')}
            className="text-gray-600 hover:text-gray-900 text-base md:text-2xl lg:text-3xl font-medium transition-colors"
          >
            Volver
          </button>
        </div>
      ...
      <main className="max-w-md mx-auto px-4 py-12">
        {showSuccessMessage ? (
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            <div className="text-center mb-8">
              ...
              <h2 className="text-base md:text-2xl lg:text-3xl font-bold text-red-600 mb-3">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full bg-gradient-to-r from-cyan-500 to-pink-500 text-white py-4 rounded-lg font-bold text-base md:text-2xl lg:text-3xl hover:from-cyan-600 hover:to-pink-600 transition-all shadow-lg hover:shadow-xl"
              >
                Enviar Consulta
              </button>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div className="mb-10">
            <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 border-2 border-cyan-300 rounded-2xl p-6 shadow-lg">
              <div className="text-center">
                ...
                <h1 className="text-lg md:text-3xl lg:text-4xl md:text-lg md:text-3xl lg:text-4xl font-bold text-cyan-600 mb-2">
                  Ingresa tu Código
                </h1>
                <p className="text-gray-700 text-sm md:text-lg md:text-3xl lg:text-4xl">
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:border-cyan-500 text-base md:text-2xl lg:text-3xl font-mono uppercase ${
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:border-cyan-500 text-base md:text-2xl lg:text-3xl ${
            ...
            <div>
              ...
              <div className="flex gap-2">
                <select
                  ...
                  disabled={codeVerified}
                  className={`px-4 py-3 border-2 rounded-lg font-semibold text-base md:text-2xl lg:text-3xl ${
                ...
                <input
                  ...
                  disabled={codeVerified}
                  className={`flex-1 px-4 py-3 border-2 rounded-lg focus:outline-none focus:border-cyan-500 text-base md:text-2xl lg:text-3xl ${
          ...
          <button
            ...
            className="w-full mt-8 bg-gradient-to-r from-cyan-500 to-pink-500 text-white py-4 rounded-lg font-bold text-base md:text-2xl lg:text-3xl hover:from-cyan-600 hover:to-pink-600 transition-all shadow-lg hover:shadow-xl"
          >
