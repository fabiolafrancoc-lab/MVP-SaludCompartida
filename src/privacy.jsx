    ...
    <div className="min-h-screen bg-gray-900" style={{paddingTop: '72px'}}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-lg md:text-3xl lg:text-4xl md:text-base md:text-2xl lg:text-3xl font-bold text-white mb-4">
            Aviso de Privacidad
          </h1>
          <p className="text-base md:text-2xl lg:text-3xl text-gray-400 max-w-3xl mx-auto">
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-12">
            ...
            <section id="intro" className="bg-gray-800 rounded-xl shadow-lg p-8">
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6 mb-4">
                <h3 className="font-bold text-white mb-3">Nuestro compromiso</h3>
            ...
            <section id="responsible" className="bg-gray-800 rounded-xl shadow-lg p-8">
              <h2 className="text-lg md:text-3xl lg:text-4xl font-bold text-white mb-6">
                2. Responsable del tratamiento
              </h2>
              <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl p-6">
                <h3 className="font-bold text-white mb-4 text-base md:text-2xl lg:text-3xl">SaludCompartida S.A.P.I. de C.V.</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <p className="text-sm text-gray-400 mb-1">CEO y Representante Legal</p>
                    <p className="font-semibold text-white">Fabiola Franco</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-400 mb-1">Correo electrónico</p>
                    <p className="font-semibold text-white">ffranco@saludcompartida.com</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-400 mb-1">Teléfono de contacto</p>
                    <p className="font-semibold text-white">+1 305 522 7150</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-400 mb-1">Sitio web</p>
                    <p className="font-semibold text-white">saludcompartida.com</p>
                  </div>
                </div>
              </div>
            ...
            <section id="data-collection" className="bg-gray-800 rounded-xl shadow-lg p-8">
              <h2 className="text-lg md:text-3xl lg:text-4xl font-bold text-white mb-6">
              ...
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-cyan-500 pl-6">
                  <h3 className="font-bold text-white mb-3 text-base md:text-2xl lg:text-3xl">Datos de identificación</h3>
                ...
                <div className="bg-red-50 border-l-4 border-red-400 pl-6 py-4 rounded-r-lg">
                  <h3 className="font-bold text-red-900 mb-3 text-base md:text-2xl lg:text-3xl flex items-center gap-2">
                ...
                <div className="border-l-4 border-purple-500 pl-6">
                  <h3 className="font-bold text-white mb-3 text-base md:text-2xl lg:text-3xl">Datos de familiares usuarios</h3>
                  <p className="text-gray-300 text-sm leading-relaxed">
                ...
                <div className="border-l-4 border-pink-500 pl-6">
                  <h3 className="font-bold text-white mb-3 text-base md:text-2xl lg:text-3xl">Datos de pago</h3>
                  <ul className="text-gray-300 text-sm space-y-2">
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <h3 className="font-bold text-white mb-3 text-base md:text-2xl lg:text-3xl">Datos de uso (únicamente estadísticos)</h3>
            ...
            <section id="purpose" className="bg-gray-800 rounded-xl shadow-lg p-8">
              <h2 className="text-lg md:text-3xl lg:text-4xl font-bold text-white mb-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="font-bold text-white mb-4 text-base md:text-2xl lg:text-3xl flex items-center gap-2">
                    <span className="bg-cyan-100 text-cyan-800 text-xs font-semibold px-2.5 py-1 rounded">PRIMARIAS</span>
                    Prestación de servicios de salud
                  </h3>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="bg-cyan-50 rounded-lg p-4">
                      <h4 className="font-semibold text-white mb-2 text-sm">Consultas médicas</h4>
                      <p className="text-gray-300 text-xs">Proveer consultas de telemedicina con profesionales certificados en México</p>
                    </div>
                    <div className="bg-cyan-50 rounded-lg p-4">
                      <h4 className="font-semibold text-white mb-2 text-sm">Recetas electrónicas</h4>
                      <p className="text-gray-300 text-xs">Gestionar recetas y su uso en farmacias asociadas</p>
                    </div>
                    <div className="bg-cyan-50 rounded-lg p-4">
                      <h4 className="font-semibold text-white mb-2 text-sm">Programa de descuentos</h4>
                      <p className="text-gray-300 text-xs">Operar el programa de descuentos en farmacias y servicios médicos</p>
                    </div>
                    <div className="bg-cyan-50 rounded-lg p-4">
                      <h4 className="font-semibold text-white mb-2 text-sm">Sesiones psicológicas</h4>
                      <p className="text-gray-300 text-xs">Facilitar terapia psicológica por videollamada</p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <h3 className="font-bold text-white mb-4 text-base md:text-2xl lg:text-3xl flex items-center gap-2">
                    <span className="bg-purple-900 text-purple-800 text-xs font-semibold px-2.5 py-1 rounded">SECUNDARIAS</span>
                  ...
                  <ul className="space-y-3 text-gray-300 text-sm">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-medium text-white">Análisis estadístico</p>
                        <p className="text-xs text-gray-400">Monitorear frecuencia y tipo de consumos para mejorar el servicio (sin identificar usuarios individuales)</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-purple-600 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div>
                        <p className="font-medium text-white">Marketing y comunicaciones</p>
                        <p className="text-xs text-gray-400">Enviar información sobre nuevos servicios, promociones y actualizaciones</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-purple-600 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div>
                        <p className="font-medium text-white">Desarrollo de productos</p>
                        <p className="text-xs text-gray-400">Desarrollar nuevos servicios y funcionalidades basados en necesidades identificadas</p>
                      </div>
                    </li>
                  </ul>
                </div>
                ...
                {/* Comunicaciones */}
                <div>
                  <h3 className="font-bold text-white mb-4 text-base md:text-2xl lg:text-3xl">Comunicaciones con usuarios</h3>
                  <ul className="text-gray-300 text-sm space-y-2">
            ...
            <section id="legal-basis" className="bg-gray-800 rounded-xl shadow-lg p-8">
              <h2 className="text-lg md:text-3xl lg:text-4xl font-bold text-white mb-6">
                5. Fundamento legal
              </h2>
              <p className="text-gray-300 mb-6 leading-relaxed">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-xl p-6">
                  ...
                  <h3 className="font-bold text-white mb-2">Consentimiento expreso</h3>
                ...
                <div className="bg-gradient-to-br from-gray-800 to-gray-700 rounded-xl p-6">
                  ...
                  <h3 className="font-bold text-white mb-2">Ejecución de contrato</h3>
                  <p className="text-gray-300 text-sm">
                ...
                <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-xl p-6">
                  ...
                  <h3 className="font-bold text-white mb-2">Interés legítimo</h3>
                  <p className="text-gray-300 text-sm">
            ...
            <section id="data-transfer" className="bg-gray-800 rounded-xl shadow-lg p-8">
              <h2 className="text-lg md:text-3xl lg:text-4xl font-bold text-white mb-6">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-cyan-50 to-blue-50 rounded-xl p-6">
                  <h3 className="font-bold text-white mb-3 text-base md:text-2xl lg:text-3xl flex items-center gap-2">
                ...
                <div className="border-l-4 border-pink-500 pl-6">
                  <h3 className="font-bold text-white mb-3 text-base md:text-2xl lg:text-3xl">Procesadores de pago</h3>
                  <p className="text-gray-300 text-sm leading-relaxed">
                ...
                <div className="border-l-4 border-purple-500 pl-6">
                  <h3 className="font-bold text-white mb-3 text-base md:text-2xl lg:text-3xl">Infraestructura tecnológica</h3>
                  <ul className="text-gray-300 text-sm space-y-2">
                ...
                <div className="bg-yellow-900/20 border-l-4 border-yellow-500 p-6 rounded-r-lg">
                  <h3 className="font-bold text-yellow-900 mb-3 text-base md:text-2xl lg:text-3xl flex items-center gap-2">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div className="bg-gray-800 rounded-lg p-4">
                    <p className="text-gray-300 text-sm font-medium mb-2">Protecciones implementadas:</p>
            ...
            <section id="arco-rights" className="bg-gradient-to-br from-cyan-500 to-purple-600 rounded-xl shadow-lg p-8 text-white">
              <h2 className="text-lg md:text-3xl lg:text-4xl font-bold mb-6">
                7. Tus Derechos ARCO
              </h2>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div className="bg-gray-800/10 backdrop-blur rounded-xl p-6">
                  <div className="w-12 h-12 bg-gray-800/20 rounded-lg flex items-center justify-center mb-4">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M10 12a2 2 0 100-4 2 2 0 000 4z" />
                      <path fillRule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clipRule="evenodd" />
                    </svg>
                  </div>
                  <h3 className="font-bold mb-2 text-base md:text-2xl lg:text-3xl">Acceso</h3>
                ...
                <div className="bg-gray-800/10 backdrop-blur rounded-xl p-6">
                  ...
                  <h3 className="font-bold mb-2 text-base md:text-2xl lg:text-3xl">Rectificación</h3>
                ...
                <div className="bg-gray-800/10 backdrop-blur rounded-xl p-6">
                  ...
                  <h3 className="font-bold mb-2 text-base md:text-2xl lg:text-3xl">Cancelación</h3>
                ...
                <div className="bg-gray-800/10 backdrop-blur rounded-xl p-6">
                  ...
                  <h3 className="font-bold mb-2 text-base md:text-2xl lg:text-3xl">Oposición</h3>
                  <p className="text-sm opacity-90">Oponerte al tratamiento de tus datos para finalidades específicas</p>
                </div>
              </div>

              <div className="bg-gray-800/20 backdrop-blur rounded-xl p-6">
                <h3 className="font-bold text-lg md:text-3xl lg:text-4xl mb-4">¿Cómo ejercer tus derechos?</h3>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <div className="bg-gray-800/20 rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 font-bold">
                      1
                    </div>
                    <div>
              ...
              <div className="mt-6 bg-gray-800/10 backdrop-blur rounded-xl p-6">
            ...
            <section id="security" className="bg-gray-800 rounded-xl shadow-lg p-8">
              <h2 className="text-lg md:text-3xl lg:text-4xl font-bold text-white mb-6">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-bold text-white text-base md:text-2xl lg:text-3xl">Encriptación</h3>
                  </div>
                  <ul className="text-gray-300 text-sm space-y-1">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-bold text-white text-base md:text-2xl lg:text-3xl">Control de acceso</h3>
                  </div>
                  <ul className="text-gray-300 text-sm space-y-1">
                ...
                <div className="bg-gradient-to-br from-gray-800 to-gray-700 rounded-xl p-6">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-bold text-white text-base md:text-2xl lg:text-3xl">Auditorías y respaldos</h3>
                  </div>
                  <ul className="text-gray-300 text-sm space-y-1">
                ...
                <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-xl p-6">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-bold text-white text-base md:text-2xl lg:text-3xl">Capacitación del personal</h3>
                  </div>
                  <ul className="text-gray-300 text-sm space-y-1">
              ...
              <div className="bg-gray-50 rounded-xl p-6 mb-6">
                <h3 className="font-bold text-white mb-3 text-base md:text-2xl lg:text-3xl">Conservación de datos</h3>
                <p className="text-gray-300 text-sm mb-3 leading-relaxed">
            ...
            <section id="cookies" className="bg-gray-800 rounded-xl shadow-lg p-8">
              <h2 className="text-lg md:text-3xl lg:text-4xl font-bold text-white mb-6">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="font-bold text-white mb-3 text-base md:text-2xl lg:text-3xl">¿Qué son las cookies?</h3>
                  <p className="text-gray-300 text-sm leading-relaxed">
                ...
                <div>
                  <h3 className="font-bold text-white mb-3 text-base md:text-2xl lg:text-3xl">Tipos de cookies que utilizamos</h3>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="bg-cyan-50 rounded-lg p-4">
                      <h4 className="font-semibold text-white mb-2 text-sm">Cookies esenciales</h4>
                      <p className="text-gray-300 text-xs mb-2">Necesarias para el funcionamiento básico de la plataforma</p>
                      <p className="text-gray-400 text-xs italic">Estas cookies no se pueden desactivar</p>
                    </div>
                    <div className="bg-purple-50 rounded-lg p-4">
                      <h4 className="font-semibold text-white mb-2 text-sm">Cookies de preferencias</h4>
                      <p className="text-gray-300 text-xs">Recuerdan tus configuraciones y preferencias personalizadas</p>
                    </div>
                    <div className="bg-blue-50 rounded-lg p-4">
                      <h4 className="font-semibold text-white mb-2 text-sm">Cookies analíticas</h4>
                      <p className="text-gray-300 text-xs">Nos ayudan a entender cómo los usuarios interactúan con nuestra plataforma</p>
                    </div>
                    <div className="bg-pink-50 rounded-lg p-4">
                      <h4 className="font-semibold text-white mb-2 text-sm">Cookies de seguridad</h4>
                      <p className="text-gray-300 text-xs">Protegen tu cuenta y detectan actividades fraudulentas</p>
                    </div>
                  </div>
                </div>

                <div>
                  <h3 className="font-bold text-white mb-3 text-base md:text-2xl lg:text-3xl">Herramientas de análisis</h3>
                  <p className="text-gray-300 text-sm mb-3 leading-relaxed">
                ...
                <div className="bg-gradient-to-r from-green-50 to-cyan-50 rounded-xl p-6">
                  <h3 className="font-bold text-white mb-3 text-base md:text-2xl lg:text-3xl">Control de cookies</h3>
                  <p className="text-gray-300 text-sm mb-3 leading-relaxed">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-medium text-white text-sm">Configuración del navegador</p>
                        <p className="text-gray-400 text-xs">La mayoría de navegadores permiten bloquear o eliminar cookies desde su configuración</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      ...
                      <div>
                        <p className="font-medium text-white text-sm">Preferencias de la plataforma</p>
                        <p className="text-gray-400 text-xs">Puedes ajustar tus preferencias de cookies desde tu cuenta</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      ...
                      <div>
                        <p className="font-medium text-white text-sm">Opt-out de análisis</p>
                        <p className="text-gray-400 text-xs">Puedes optar por no participar en Google Analytics instalando su complemento de navegador</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section id="minors" className="bg-gray-800 rounded-xl shadow-lg p-8">
              <h2 className="text-lg md:text-3xl lg:text-4xl font-bold text-white mb-6">
                10. Menores de edad
              </h2>
              ...
              <div className="bg-gradient-to-r from-orange-50 to-pink-50 rounded-xl p-6 mb-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-white mb-2 text-base md:text-2xl lg:text-3xl">Protección de menores</h3>
                    <p className="text-gray-300 text-sm leading-relaxed">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="font-bold text-white mb-3 text-base md:text-2xl lg:text-3xl">Requisitos para menores de 18 años</h3>
                  <ul className="space-y-3 text-gray-300 text-sm">
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-cyan-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400 mt-1">El padre, madre o tutor legal debe autorizar el uso del servicio y el tratamiento de datos personales del menor</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-cyan-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400 mt-1">Se recomienda la presencia de un adulto responsable durante las consultas médicas y psicológicas</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-cyan-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400 mt-1">Los datos de salud de menores reciben protección adicional bajo nuestra política de seguridad</p>
                      </div>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-blue-50 rounded-xl p-6">
                  <h3 className="font-bold text-white mb-3 text-base md:text-2xl lg:text-3xl">Derechos de los padres o tutores</h3>
                  <p className="text-gray-300 text-sm mb-3 leading-relaxed">
                ...
                <div className="bg-purple-50 rounded-xl p-6">
                  <h3 className="font-bold text-white mb-3 text-base md:text-2xl lg:text-3xl">Limitaciones para menores</h3>
                  <ul className="text-gray-300 text-sm space-y-2">
            ...
            <section id="changes" className="bg-gray-800 rounded-xl shadow-lg p-8">
              <h2 className="text-lg md:text-3xl lg:text-4xl font-bold text-white mb-6">
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-cyan-50 to-purple-50 rounded-xl p-6">
                  <h3 className="font-bold text-white mb-4 text-base md:text-2xl lg:text-3xl">¿Cuándo podemos modificar este aviso?</h3>
                  <ul className="text-gray-300 text-sm space-y-2">
                ...
                <div>
                  <h3 className="font-bold text-white mb-4 text-base md:text-2xl lg:text-3xl">Cómo te notificaremos</h3>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="bg-cyan-50 rounded-lg p-4 flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400">A la dirección registrada en tu cuenta</p>
                      </div>
                    </div>
                    <div className="bg-purple-50 rounded-lg p-4 flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-white text-sm">Notificación en la app</p>
                        <p className="text-xs text-gray-400">Mensaje destacado en la aplicación móvil</p>
                      </div>
                    </div>
                    <div className="bg-green-50 rounded-lg p-4 flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400">Mensaje informativo directo</p>
                      </div>
                    </div>
                    <div className="bg-pink-50 rounded-lg p-4 flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-white text-sm">Sitio web</p>
                        <p className="text-xs text-gray-400">Aviso destacado en saludcompartida.com</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <h3 className="font-bold text-white mb-3 text-base md:text-2xl lg:text-3xl">Historial de versiones</h3>
                  <p className="text-gray-300 text-sm mb-3 leading-relaxed">
                  ...
                  <div className="bg-gray-800 rounded-lg p-4">
                    <p className="text-sm text-gray-300"><strong>Versión actual:</strong> 1.0</p>
                    <p className="text-sm text-gray-300"><strong>Fecha de publicación:</strong> 7 de noviembre de 2025</p>
                    <p className="text-sm text-gray-300"><strong>Fecha efectiva:</strong> 7 de noviembre de 2025</p>
                  </div>
                </div>
              </div>
            </section>
