    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
      ...
      <section className="px-6 pt-12 pb-8">
        <div className="flex flex-col items-center justify-center text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-9xl font-black mb-4 text-center w-full">
            <span className="text-cyan-400 block">SaludCompartida</span>
          </h1>
          <h2 className="text-lg md:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent text-center w-full">
