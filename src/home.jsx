    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
      ...
      <div className="bg-gradient-to-r from-red-700 via-red-600 to-red-700 py-6 px-safe mt-16 border-y-4 border-red-400 shadow-2xl shadow-red-900/50">
        <div className="flex items-center justify-center gap-3 text-center">
          ...
          <p className="font-black text-white">
            <span className="text-base md:text-base block md:inline">
              AHORA MISMO, <span className="text-yellow-300 animate-pulse">{1847 + counter}</span> FAMILIAS
            </span>
            <span className="text-lg md:text-lg block md:inline md:ml-2 mt-1 md:mt-0">
      ...
      <section className="w-full px-safe py-safe">
        <div className="w-full max-w-4xl mx-auto text-left">
          ...
          <h1 className="text-base sm:text-base md:text-base lg:text-lg font-black mb-4 w-full">
            <span className="text-cyan-400 block">SaludCompartida</span>
          </h1>
          <h2 className="text-base sm:text-lg md:text-lg lg:text-base font-bold bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent w-full">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6">
              <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
                <div className="bg-red-500/20 border border-red-500/40 rounded-xl px-4 py-2 flex-shrink-0">
                  <span className="text-lg sm:text-base font-black text-red-400">$576</span>
              ...
              <div className="bg-green-500/20 border border-green-500/40 rounded-xl px-4 py-2 text-center flex-shrink-0">
                ...
                <span className="text-base sm:text-lg font-black text-green-400">${savings}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="w-full px-safe py-safe bg-gray-800/30">
        <div className="w-full max-w-4xl mx-auto">
          <h3 className="text-base sm:text-lg font-bold text-center mb-4 sm:mb-6 text-white">
      ...
      <section className="w-full px-safe py-safe">
        <div className="w-full max-w-5xl mx-auto">
          <h3 className="text-lg sm:text-base md:text-lg font-bold text-center mb-2 text-white">
            ¿Qué obtienes con
          </h3>
          <h3 className="text-lg sm:text-base md:text-lg font-black text-center mb-6 sm:mb-8 text-cyan-400">
            SaludCompartida?
          </h3>
      ...
      <section className="w-full px-safe py-safe">
        <div className="w-full max-w-3xl mx-auto">
          <div className="w-full bg-gradient-to-r from-cyan-600 to-cyan-500 rounded-xl sm:rounded-2xl p-6 md:p-8 text-center text-white">
            <h2 className="text-lg sm:text-base md:text-lg font-bold mb-2">
              ...
              <div className="my-4 inline-flex items-center gap-2 sm:gap-3 bg-white/10 rounded-xl px-3 sm:px-4 py-2">
                ...
                <span className="text-base sm:text-lg font-black">$12/mes</span>
              </div>
