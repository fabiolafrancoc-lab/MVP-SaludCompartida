...
export default function Telemedicine() {
  ...
  const handleSupportWhatsApp = () => {
    // Función para contactar soporte de Salud Compartida (otras consultas)
    let firstName = '';
    try {
      const currentUserData = localStorage.getItem('currentUser');
      if (currentUserData) {
    ...
    const whatsappMessage = encodeURIComponent(
      ...
      `1️⃣ Agendar mi cita con mi Terapeuta\n` +
      `2️⃣ Consultas sobre mis Ahorros\n` +
      `3️⃣ Otras Consultas\n\n` +
      ...
      <main className="max-w-7xl mx-auto px-safe py-safe">
        ...
        <div className="relative bg-gradient-to-r from-teal-600 to-teal-500 rounded-3xl overflow-hidden shadow-2xl mb-8">
          ...
          <div className="relative z-10 px-8 py-12 text-white">
            ...
            <h1 className="text-lg md:text-3xl lg:text-4xl md:text-base md:text-2xl lg:text-3xl font-bold mb-4">
              Doctor a tu alcance
              <br />
              <span className="text-yellow-300">cuando más lo necesitas</span>
            </h1>

            <p className="text-lg md:text-3xl lg:text-4xl text-teal-50 mb-6 max-w-2xl">
              Habla con un doctor ahora mismo por teléfono o WhatsApp.
              Llámanos o manda mensaje de voz. Sin citas, sin esperas.
            </p>

            {/* CTA Principal */}
            <button
              onClick={handleWhatsAppCall}
              className="group bg-green-500 hover:bg-green-600 text-white px-10 py-6 rounded-2xl text-base md:text-2xl lg:text-3xl font-bold shadow-2xl hover:shadow-green-500/50 transition-all transform hover:scale-105 flex items-center gap-4"
            >
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 mb-8 border-2 border-orange-200">
          <div className="text-center">
            <h2 className="text-base md:text-2xl lg:text-3xl font-bold text-gray-800 mb-4">
            ...
            <div className="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-2xl p-6 min-h-[100px] flex items-center justify-center">
              <p 
                key={currentPhrase}
                className="text-base md:text-2xl lg:text-3xl md:text-lg md:text-3xl lg:text-4xl font-bold italic animate-fade-in transition-colors duration-500"
                style={{ color: phrases[currentPhrase].color }}
              >
                "{phrases[currentPhrase].text}"
              </p>
            </div>
            <p className="text-gray-600 mt-4 text-base md:text-2xl lg:text-3xl">
        ...
        <div className="relative rounded-3xl overflow-hidden shadow-2xl mb-8">
          ...
          <div className="absolute bottom-0 left-0 right-0 px-8 py-12 text-white">
            <h2 className="text-lg md:text-3xl lg:text-4xl md:text-base md:text-2xl lg:text-3xl font-bold mb-4">
              Consulta desde casa
            </h2>
            <p className="text-lg md:text-3xl lg:text-4xl text-white/90">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-teal-50 rounded-3xl shadow-xl p-8 mb-8">
          <h2 className="text-lg md:text-3xl lg:text-4xl font-bold text-center text-gray-800 mb-8">
            ¿Cómo funciona?
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-2xl p-6 text-center shadow-lg">
              <div className="bg-teal-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-lg md:text-3xl lg:text-4xl font-bold text-teal-600">1</span>
              </div>
              <h3 className="text-lg md:text-3xl lg:text-4xl font-bold text-gray-800 mb-2">
                Presiona "Llamar o Enviar Audio"
              </h3>
              <p className="text-gray-600">
                Un click te abre WhatsApp, llama o manda audio de voz
              </p>
            </div>

            <div className="bg-white rounded-2xl p-6 text-center shadow-lg">
              <div className="bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-lg md:text-3xl lg:text-4xl font-bold text-green-600">2</span>
              </div>
              <h3 className="text-lg md:text-3xl lg:text-4xl font-bold text-gray-800 mb-2">
                Describe tu problema
              </h3>
              <p className="text-gray-600">
                Habla como siempre lo haces, usa audio de voz o llama directamente
              </p>
            </div>

            <div className="bg-white rounded-2xl p-6 text-center shadow-lg">
              <div className="bg-orange-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-lg md:text-3xl lg:text-4xl font-bold text-orange-600">3</span>
              </div>
              <h3 className="text-lg md:text-3xl lg:text-4xl font-bold text-gray-800 mb-2">
        ...
        <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-3xl shadow-2xl p-12 text-center">
          ...
          <p className="text-base md:text-2xl lg:text-3xl text-green-50 mb-8">
            Un doctor está esperando tu llamada o mensaje de voz ahora mismo
          </p>
          <button
            onClick={handleWhatsAppCall}
            className="group bg-white text-[#25D366] px-12 py-6 rounded-2xl text-base md:text-2xl lg:text-3xl font-bold shadow-2xl hover:shadow-green-500/50 transition-all transform hover:scale-105 inline-flex items-center gap-4"
          >
            <WhatsAppIconGreen className="w-10 h-10" />
            <span>Conectar con Doctor 🩺🎤</span>
          </button>

          {/* Disclaimer del Proveedor */}
          <div className="mt-6 bg-white/10 backdrop-blur-sm rounded-xl p-4 text-white/80 text-sm">
            <p className="italic">
              ℹ️ Servicio de telemedicina proporcionado por nuestro proveedor médico asociado. 
              Salud Compartida facilita la conexión, el desempeño del servicio es responsabilidad del proveedor.
            </p>
          </div>

          <div className="mt-8">
            <p className="text-white/90 text-lg md:text-3xl lg:text-4xl mb-3">
            ...
            <button
              ...
              className="bg-white/20 hover:bg-white/30 text-white px-6 py-2 rounded-lg font-semibold text-lg md:text-3xl lg:text-4xl transition-all"
            >
              Ver Farmacias con Descuento
            </button>
          </div>

          {/* Botón Secundario para Otras Consultas */}
          <div className="mt-8 pt-6 border-t border-white/20">
            <p className="text-white/90 text-base mb-4">
              ¿Necesitas ayuda con terapia o consultas sobre tu plan?
            </p>
            <button
              onClick={handleSupportWhatsApp}
              className="bg-white/20 hover:bg-white/30 text-white px-8 py-3 rounded-xl font-semibold text-base transition-all inline-flex items-center gap-2"
            >
        ...
        <div className="mt-12 flex justify-center pb-8">
          <button
            ...
            className="group flex items-center gap-3 px-8 py-4 bg-white hover:bg-gray-50 text-cyan-600 rounded-xl font-bold text-base md:text-2xl lg:text-3xl shadow-lg hover:shadow-xl transition-all"
          >
