    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-blue-50">
      ...
      <main className="max-w-7xl mx-auto px-safe py-safe">
        ...
        <div className="relative bg-gradient-to-r from-teal-600 to-teal-500 rounded-3xl overflow-hidden shadow-2xl mb-8">
          ...
          <div className="relative z-10 px-8 py-12 text-white">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-base font-bold bg-green-400 text-green-900 px-4 py-1 rounded-full">
                Disponible 24/7
              </span>
            </div>

            <h1 className="text-base md:text-lg font-bold mb-4">
              Doctor a tu alcance
              <br />
              <span className="text-yellow-300">cuando más lo necesitas</span>
            </h1>

            <p className="text-base text-teal-50 mb-6 max-w-2xl">
            ...
            <button
              ...
              className="group bg-green-500 hover:bg-green-600 text-white px-10 py-6 rounded-2xl text-lg font-bold shadow-2xl hover:shadow-green-500/50 transition-all transform hover:scale-105 flex items-center gap-4"
            >
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 mb-8 border-2 border-orange-200">
          <div className="text-center">
            ...
            <div className="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-2xl p-6 min-h-[100px] flex items-center justify-center">
              <p 
                key={currentPhrase}
                className="text-lg md:text-base font-bold italic animate-fade-in transition-colors duration-500"
        ...
        <div className="bg-gradient-to-br from-blue-50 to-teal-50 rounded-3xl shadow-xl p-8 mb-8">
          <h2 className="text-base font-bold text-center text-gray-800 mb-8">
            ¿Cómo funciona?
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 text-center shadow-lg">
              <div className="bg-orange-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-base font-bold text-orange-600">3</span>
              </div>
              <h3 className="text-base font-bold text-gray-800 mb-2">
        ...
        <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-3xl shadow-2xl p-12 text-center">
          ...
          <button
            onClick={handleWhatsAppCall}
            className="group bg-white text-[#25D366] px-12 py-6 rounded-2xl text-lg font-bold shadow-2xl hover:shadow-green-500/50 transition-all transform hover:scale-105 inline-flex items-center gap-4"
          >
