    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-blue-50">
      ...
      <main className="max-w-7xl mx-auto px-safe py-safe">
        ...
        <div className="relative bg-gradient-to-r from-teal-600 to-teal-500 rounded-3xl overflow-hidden shadow-2xl mb-8">
          ...
          <div className="relative z-10 px-8 py-12 text-white">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-3xl font-bold bg-green-400 text-green-900 px-4 py-1 rounded-full">
                Disponible 24/7
              </span>
            </div>
            ...
            <p className="text-3xl text-teal-50 mb-6 max-w-2xl">
        ...
        <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-3xl shadow-2xl p-12 text-center">
          ...
          <div className="mt-6">
            <p className="text-white/90 text-3xl mb-3">
            ...
            <button
              ...
              className="bg-white/20 hover:bg-white/30 text-white px-6 py-2 rounded-lg font-semibold text-3xl transition-all"
            >
        ...
        <div className="mt-12 flex justify-center pb-8">
          <button
            ...
            className="group flex items-center gap-3 px-8 py-4 bg-white hover:bg-gray-50 text-cyan-600 rounded-xl font-bold text-2xl shadow-lg hover:shadow-xl transition-all"
          >
