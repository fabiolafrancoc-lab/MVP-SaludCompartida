...
export default function PagoTerms() {
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
              <div className="prose prose-lg max-w-none">
                <section id="intro" className="mb-12">
                  <h2 className="text-base md:text-2xl lg:text-3xl font-bold text-gray-900 mb-6 pb-3 border-b-2 border-cyan-500">
                ...
                <section id="services" className="mb-12">
                  ...
                  <h3 className="text-lg md:text-3xl lg:text-4xl font-bold text-gray-900 mt-6 mb-3">Telemedicina 24/7</h3>
                  ...
                  <h3 className="text-lg md:text-3xl lg:text-4xl font-bold text-gray-900 mt-6 mb-3">Terapia y Salud Mental</h3>
                  <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-6">
                  ...
                  <h3 className="text-lg md:text-3xl lg:text-4xl font-bold text-gray-900 mt-6 mb-3">Descuentos en Farmacias</h3>
                  <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-6">
                  ...
                  <h3 className="text-lg md:text-3xl lg:text-4xl font-bold text-gray-900 mt-6 mb-3">Gestión de Ahorros</h3>
                  <ul className="list-disc pl-6 text-gray-700 space-y-2">
                ...
                <section id="subscription" className="mb-12">
                  ...
                  <div className="bg-cyan-50 border border-cyan-200 rounded-lg p-6 mb-6">
                    <h3 className="text-lg md:text-3xl lg:text-4xl font-bold text-gray-900 mb-3">Costo de Suscripción</h3>
                  ...
                  <h3 className="text-lg md:text-3xl lg:text-4xl font-bold text-gray-900 mb-3">Métodos de Pago</h3>
                  <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-6">
                  ...
                  <h3 className="text-lg md:text-3xl lg:text-4xl font-bold text-gray-900 mb-3">Cancelación</h3>
                ...
                <section id="usage" className="mb-12">
                  ...
                  <h3 className="text-lg md:text-3xl lg:text-4xl font-bold text-gray-900 mb-3">Responsabilidades del Usuario</h3>
                  <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-6">
                  ...
                  <h3 className="text-lg md:text-3xl lg:text-4xl font-bold text-gray-900 mb-3">Conducta Prohibida</h3>
                  <ul className="list-disc pl-6 text-gray-700 space-y-2">
                ...
                <section id="limitations" className="mb-12">
                  ...
                  <h3 className="text-lg md:text-3xl lg:text-4xl font-bold text-gray-900 mb-3">Exclusiones</h3>
                ...
                <section id="responsibilities" className="mb-12">
                  ...
                  <h3 className="text-lg md:text-3xl lg:text-4xl font-bold text-gray-900 mb-3">De SaludCompartida</h3>
                  <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-6">
                  ...
                  <h3 className="text-lg md:text-3xl lg:text-4xl font-bold text-gray-900 mb-3">Del Usuario</h3>
                  <ul className="list-disc pl-6 text-gray-700 space-y-2">
                ...
                <div className="mt-12 pt-8 border-t-2 border-gray-200">
                  ...
                  <p className="text-center">
                    <a href="mailto:legal@saludcompartida.com" className="text-cyan-600 font-semibold hover:underline text-base md:text-2xl lg:text-3xl">
