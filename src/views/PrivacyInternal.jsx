...
export default function PrivacyInternal() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-purple-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="lg:col-span-3 space-y-12">
            ...
            <section id="responsible" className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl p-6">
                <h3 className="font-bold text-gray-900 mb-4 text-base md:text-2xl lg:text-3xl">SaludCompartida S.A.P.I. de C.V.</h3>
            ...
            <section id="data-collection" className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-purple-500 pl-6">
                  <h3 className="font-bold text-gray-900 mb-3 text-base md:text-2xl lg:text-3xl">Datos de familiares usuarios</h3>
                  <p className="text-gray-700 text-sm leading-relaxed">
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <h3 className="font-bold text-gray-900 mb-3 text-base md:text-2xl lg:text-3xl">Datos de uso (únicamente estadísticos)</h3>
            ...
            <section id="purpose" className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 mb-4 text-base md:text-2xl lg:text-3xl flex items-center gap-2">
                ...
                {/* Comunicaciones */}
                <div>
                  <h3 className="font-bold text-gray-900 mb-4 text-base md:text-2xl lg:text-3xl">Comunicaciones con usuarios</h3>
                  <ul className="text-gray-700 text-sm space-y-2">
            ...
            <section id="data-transfer" className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-cyan-50 to-blue-50 rounded-xl p-6">
                  <h3 className="font-bold text-gray-900 mb-3 text-base md:text-2xl lg:text-3xl flex items-center gap-2">
                ...
                <div className="border-l-4 border-pink-500 pl-6">
                  <h3 className="font-bold text-gray-900 mb-3 text-base md:text-2xl lg:text-3xl">Procesadores de pago</h3>
                  <p className="text-gray-700 text-sm leading-relaxed">
                ...
                <div className="border-l-4 border-purple-500 pl-6">
                  <h3 className="font-bold text-gray-900 mb-3 text-base md:text-2xl lg:text-3xl">Infraestructura tecnológica</h3>
                  <ul className="text-gray-700 text-sm space-y-2">
            ...
            <section id="security" className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-bold text-gray-900 text-base md:text-2xl lg:text-3xl">Encriptación</h3>
                  </div>
                  <ul className="text-gray-700 text-sm space-y-1">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-bold text-gray-900 text-base md:text-2xl lg:text-3xl">Control de acceso</h3>
                  </div>
                  <ul className="text-gray-700 text-sm space-y-1">
                ...
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-bold text-gray-900 text-base md:text-2xl lg:text-3xl">Auditorías y respaldos</h3>
                  </div>
                  <ul className="text-gray-700 text-sm space-y-1">
                ...
                <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-xl p-6">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-bold text-gray-900 text-base md:text-2xl lg:text-3xl">Capacitación del personal</h3>
                  </div>
                  <ul className="text-gray-700 text-sm space-y-1">
              ...
              <div className="bg-gray-50 rounded-xl p-6 mb-6">
                <h3 className="font-bold text-gray-900 mb-3 text-base md:text-2xl lg:text-3xl">Conservación de datos</h3>
                <p className="text-gray-700 text-sm mb-3 leading-relaxed">
            ...
            <section id="cookies" className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="font-bold text-gray-900 mb-3 text-base md:text-2xl lg:text-3xl">¿Qué son las cookies?</h3>
                  <p className="text-gray-700 text-sm leading-relaxed">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 mb-3 text-base md:text-2xl lg:text-3xl">Tipos de cookies que utilizamos</h3>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="bg-cyan-50 rounded-lg p-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 mb-3 text-base md:text-2xl lg:text-3xl">Herramientas de análisis</h3>
                  <p className="text-gray-700 text-sm mb-3 leading-relaxed">
                ...
                <div className="bg-gradient-to-r from-green-50 to-cyan-50 rounded-xl p-6">
                  <h3 className="font-bold text-gray-900 mb-3 text-base md:text-2xl lg:text-3xl">Control de cookies</h3>
                  <p className="text-gray-700 text-sm mb-3 leading-relaxed">
            ...
            <section id="minors" className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="bg-gradient-to-r from-orange-50 to-pink-50 rounded-xl p-6 mb-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 mb-2 text-base md:text-2xl lg:text-3xl">Protección de menores</h3>
                    <p className="text-gray-700 text-sm leading-relaxed">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="font-bold text-gray-900 mb-3 text-base md:text-2xl lg:text-3xl">Requisitos para menores de 18 años</h3>
                  <ul className="space-y-3 text-gray-700 text-sm">
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-cyan-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                ...
                <div className="bg-blue-50 rounded-xl p-6">
                  <h3 className="font-bold text-gray-900 mb-3 text-base md:text-2xl lg:text-3xl">Derechos de los padres o tutores</h3>
                  <p className="text-gray-700 text-sm mb-3 leading-relaxed">
                ...
                <div className="bg-purple-50 rounded-xl p-6">
                  <h3 className="font-bold text-gray-900 mb-3 text-base md:text-2xl lg:text-3xl">Limitaciones para menores</h3>
                  <ul className="text-gray-700 text-sm space-y-2">
            ...
            <section id="changes" className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-cyan-50 to-purple-50 rounded-xl p-6">
                  <h3 className="font-bold text-gray-900 mb-4 text-base md:text-2xl lg:text-3xl">¿Cuándo podemos modificar este aviso?</h3>
                  <ul className="text-gray-700 text-sm space-y-2">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 mb-4 text-base md:text-2xl lg:text-3xl">Cómo te notificaremos</h3>
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <h3 className="font-bold text-gray-900 mb-3 text-base md:text-2xl lg:text-3xl">Historial de versiones</h3>
                  <p className="text-gray-700 text-sm mb-3 leading-relaxed">
        ...
        <div className="mt-16 text-center border-t border-gray-200 pt-8">
          ...
          <button
            onClick={() => navigate('/terms-internal', { state: { from: '/privacy' } })}
