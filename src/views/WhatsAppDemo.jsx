    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-lg md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="text-center mb-6">
              <h2 className="text-base md:text-2xl lg:text-3xl font-bold text-pink-600 mb-2">
                Diseño Magenta
              </h2>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="text-center mb-6">
              <h2 className="text-base md:text-2xl lg:text-3xl font-bold text-cyan-600 mb-2">
                Diseño Cyan
              </h2>
              <p className="text-gray-600">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-16">
          <h2 className="text-base md:text-2xl lg:text-3xl font-bold text-gray-900 mb-6 text-center">
            Comparación de Estilos
          </h2>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="font-bold text-pink-600 mb-4 text-base md:text-2xl lg:text-3xl">🌸 Magenta - Recomendado para:</h3>
            ...
            <div>
              <h3 className="font-bold text-cyan-600 mb-4 text-base md:text-2xl lg:text-3xl">💙 Cyan - Recomendado para:</h3>
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start gap-2">
        ...
        <div className="bg-gray-900 rounded-2xl shadow-xl p-8 text-white">
          <h2 className="text-base md:text-2xl lg:text-3xl font-bold mb-4">Cómo Usar</h2>
