      ...
      <div className="bg-white shadow-sm border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <button
            ...
            className="bg-gradient-to-r from-cyan-500 to-cyan-600 text-white font-bold px-4 md:px-6 py-2 md:py-3 rounded-lg hover:shadow-lg transition-all text-sm md:text-lg md:text-3xl lg:text-4xl flex items-center gap-2"
          >
