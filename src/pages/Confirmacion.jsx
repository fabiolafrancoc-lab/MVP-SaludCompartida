        ...
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="bg-gradient-to-r from-cyan-500 to-cyan-600 text-white font-bold px-3 md:px-4 py-2 rounded-lg hover:shadow-lg transition-all text-xs md:text-sm flex items-center gap-2"
            >
            ...
            <button
              ...
              className="bg-white border-2 border-cyan-500 text-cyan-600 font-bold px-3 md:px-4 py-2 rounded-lg hover:bg-cyan-50 transition-all text-xs md:text-sm flex items-center gap-2"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex-1 px-safe py-safe">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-lg md:text-3xl lg:text-4xl md:text-lg md:text-3xl lg:text-4xl font-bold text-gray-900 mb-3">
              ¡Suscripción Exitosa!
            </h1>
            <p className="text-base md:text-2xl lg:text-3xl text-gray-600 mb-2">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-6">
            <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-200">
              <h2 className="text-lg md:text-3xl lg:text-4xl font-bold text-gray-900">Comprobante de Pago</h2>
              <button
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gradient-to-r from-cyan-50 to-pink-50 rounded-xl p-4">
                ...
                <p className="text-base md:text-2xl lg:text-3xl font-bold text-gray-900 tracking-wider">
                  {data.confirmationNumber}
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-xl p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <p className="text-base md:text-2xl lg:text-3xl font-bold text-gray-900">{data.plan}</p>
                </div>
                <div className="flex items-center justify-between pt-3 border-t border-gray-200">
                  <p className="text-sm text-gray-600">Total Pagado</p>
                  <p className="text-base md:text-2xl lg:text-3xl font-bold text-cyan-600">${data.amount} USD</p>
                </div>
              </div>
                  ...
                  <div className="space-y-3">
                    {data.migrantAccessCode && (
                      <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg p-4">
                        ...
                        <p className="text-base md:text-2xl lg:text-3xl font-bold text-cyan-700 tracking-wider font-mono">
                          {data.migrantAccessCode}
                        </p>
                    ...
                    {data.familyAccessCode && (
                      <div className="bg-gradient-to-r from-pink-50 to-purple-50 rounded-lg p-4">
                        ...
                        <p className="text-base md:text-2xl lg:text-3xl font-bold text-pink-700 tracking-wider font-mono">
                          {data.familyAccessCode}
                        </p>
                        <p className="text-xs text-gray-600 mt-2">
