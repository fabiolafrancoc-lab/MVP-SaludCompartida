      ...
      <section className="relative bg-white py-32 md:py-40 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto mb-16">
          <div className="bg-gradient-to-br from-cyan-50 to-blue-50 border border-cyan-200 rounded-3xl p-10 md:p-12 shadow-lg">
            <h2 className="text-3xl md:text-3xl font-bold text-cyan-600 mb-6">
              Por qué existimos
            </h2>
            <p className="text-3xl md:text-2xl text-gray-700 leading-relaxed">
            ...
            <p className="text-3xl md:text-2xl text-gray-900 font-semibold mt-6">
        ...
        <div className="max-w-5xl mx-auto mb-16">
          <div className="bg-gradient-to-br from-pink-50 to-red-50 border-l-4 border-pink-500 rounded-r-3xl p-10 md:p-12 shadow-lg">
            <h2 className="text-3xl md:text-3xl font-bold text-pink-600 mb-6">
              El peso que cargas
            </h2>
            <div className="space-y-4 text-2xl md:text-3xl text-gray-700 leading-relaxed">
              <p>
              ...
              <p className="text-3xl md:text-2xl text-pink-700 font-semibold italic">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-3xl p-10 md:p-12 text-center shadow-lg">
            ...
            <p className="text-3xl md:text-2xl text-gray-700 leading-relaxed mb-6">
            ...
            <p className="text-2xl md:text-3xl font-bold mt-6 bg-gradient-to-r from-cyan-600 to-pink-600 bg-clip-text text-transparent">
