  ...
  <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-pink-50 to-gray-50">
        ...
        <div className="bg-gradient-to-r from-teal-500 to-cyan-500 text-white py-3 px-safe shadow-lg animate-slide-down">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-3">
              <LocationPinIcon />
              <p className="text-sm md:text-lg md:text-3xl lg:text-4xl font-medium">
      ...
      {showWelcomeBanner && (
        <div className="bg-gradient-to-r from-purple-500 via-pink-500 to-cyan-500 text-white py-6 px-safe shadow-lg relative">
          ...
          <div className="max-w-7xl mx-auto pr-12">
            ...
            <p className="text-lg md:text-3xl lg:text-4xl md:text-base md:text-2xl lg:text-3xl leading-relaxed max-w-5xl mb-4">
            ...
            <div className="grid md:grid-cols-3 gap-4 max-w-5xl">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3">
                <p className="font-bold text-base md:text-2xl lg:text-3xl mb-1">🏥 Telemedicina 24/7</p>
                <p className="text-sm">Habla con doctores certificados cuando lo necesites</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3">
                <p className="font-bold text-base md:text-2xl lg:text-3xl mb-1">💊 Descuento en Farmacias</p>
                <p className="text-sm">Hasta 75% OFF en medicamentos</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3">
                <p className="font-bold text-base md:text-2xl lg:text-3xl mb-1">🧠 Terapia con Psicólogos</p>
      ...
      <main className="container mx-auto px-safe py-safe">
        ...
        <div className="text-center mb-16">
          {userName && (
            <h1 className="text-base md:text-2xl lg:text-3xl md:text-lg md:text-3xl lg:text-4xl font-black mb-6 leading-tight">
              ¡Hola <span className="bg-gradient-to-r from-cyan-500 to-pink-500 bg-clip-text text-transparent">
                {userName}
              </span>!
            </h1>
          )}
          <h2 className="text-lg md:text-3xl lg:text-4xl md:text-base md:text-2xl lg:text-3xl font-black text-gray-900 mb-6 leading-tight">
            Todo lo que tu familia necesita
          </h2>
          <p className="text-lg md:text-3xl lg:text-4xl md:text-base md:text-2xl lg:text-3xl text-gray-600 max-w-3xl mx-auto font-medium">
