    ...
    <>
      ...
      <section className="px-6 pt-12 pb-8">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-lg md:text-3xl lg:text-4xl md:text-9xl font-black mb-4">
            <span className="text-cyan-400">SaludCompartida</span>
          </h1>
          <h2 className="text-lg md:text-3xl lg:text-4xl md:text-lg md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                <div className="bg-red-500/20 border border-red-500/40 rounded-xl px-4 py-2">
                  <span className="text-lg md:text-3xl lg:text-4xl font-black text-red-400">$576</span>
              ...
              <div className="bg-green-500/20 border border-green-500/40 rounded-xl px-4 py-2 text-center">
                ...
                <span className="text-base md:text-2xl lg:text-3xl font-black text-green-400">${savings}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="px-6 py-8 bg-gray-800/30">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-base md:text-2xl lg:text-3xl font-bold text-center mb-6 text-white">
          ...
          <p className="text-center text-white font-bold text-base md:text-2xl lg:text-3xl mt-4">Así de simple. Así de rápido.</p>
        </div>
      </section>
      ...
      <section className="px-6 py-10">
        <div className="max-w-5xl mx-auto">
          <h3 className="text-lg md:text-3xl lg:text-4xl md:text-base md:text-2xl lg:text-3xl font-bold text-center mb-2 text-white">
            ¿Qué obtienes con
          </h3>
          <h3 className="text-lg md:text-3xl lg:text-4xl md:text-base md:text-2xl lg:text-3xl font-black text-center mb-8 text-cyan-400">
            SaludCompartida?
          </h3>
      ...
      <section className="px-6 py-10">
        <div className="max-w-3xl mx-auto">
          <div className="bg-gradient-to-r from-cyan-600 to-cyan-500 rounded-2xl p-6 md:p-8 text-center text-white">
            <h2 className="text-lg md:text-3xl lg:text-4xl md:text-base md:text-2xl lg:text-3xl font-bold mb-2">
            ...
            <div className="my-4 inline-flex items-center gap-3 bg-white/10 rounded-xl px-4 py-2">
              ...
              <span className="text-base md:text-2xl lg:text-3xl font-black">$12/mes</span>
            </div>
