        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between z-10">
          <div className="flex items-center">
            ...
            <div>
              ...
              <h2 className="text-lg md:text-3xl lg:text-4xl font-bold text-gray-900">{article.title}</h2>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-8">
          ...
          {article.actionItems && article.actionItems.length > 0 && (
            <div className="mt-8 bg-gradient-to-r from-cyan-50 to-purple-50 rounded-xl p-6">
              <h3 className="text-lg md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 flex items-center">
