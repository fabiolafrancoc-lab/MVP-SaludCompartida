    ...
    <section className="py-12 md:py-16 bg-gradient-to-br from-gray-900 via-gray-800 to-black overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        <div className="text-center mb-8 md:mb-12">
          <h3 className="text-base md:text-2xl lg:text-3xl md:text-lg md:text-3xl lg:text-4xl font-black text-white mb-2">
            Historias reales de familias como la tuya
          </h3>
          <p className="text-lg md:text-3xl lg:text-4xl md:text-base md:text-2xl lg:text-3xl text-gray-400">
            ...
            >
              ...
              `}>
                <div className="flex items-start gap-3">
                  <span className="text-base md:text-2xl lg:text-3xl md:text-lg md:text-3xl lg:text-4xl flex-shrink-0">{bubble.icon}</span>
                  <p className="text-white text-sm md:text-lg md:text-3xl lg:text-4xl font-semibold leading-snug">
                    {bubble.text}
                  </p>
                </div>
              </div>
